...
namespace RecipeApp.Areas.Identity.Pages.Account.Manage
{
    public class DeletePersonalDataModel : PageModel
    {
        ...
        public DeletePersonalDataModel(
            ...
            RecipeApp.Models.RecipeAppContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // Recipe tablosunda UserId ile ilişkili olan kayıtları sil
            var recipes = await _context.Recipes.Where(r => r.UserId == userId).ToListAsync();
            _context.Recipes.RemoveRange(recipes);

            var comments = await _context.Comments.Where(r => r.UserId == userId).ToListAsync();
            _context.Comments.RemoveRange(comments);

            //var ingredients = await _context.Ingredients.Where(r => r.UserId == userId).ToListAsync();
            //_context.Ingredients.RemoveRange(recipes);
